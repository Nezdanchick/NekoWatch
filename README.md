...
- [x] Добавть раздел "связанное" на страницу аниме
- [x] Заменить избранное на закладки(просмотрено, в планах и тд....) перенести туда историю, сделать полноценные настройки
- [x] Добавить альтернативные плееры
